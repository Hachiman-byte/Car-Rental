...
<body>
	<h1 class="path">Admin | Category</h1>
	<p class="path1">Admin > <i style="color: blue;">Category</i> </p>
	<div class="top-left">
				...
				?>
					<tr>
						...
						<td style="text-align: center;">
							<form method="get">
								<a class="edit" href="upcategory.php?edit=<?php echo $rows['category_id']; ?>">Edit</a>
								<a class="delete" href="category.php?del=<?php echo $rows['category_id']; ?>">Delete<a/>
							</form>
						</td>
					</tr>
				<?php
	...
	<?php
		if (isset($_GET['add'])) {
		 	...
		 	$sql_insert = "INSERT INTO category(category_name) VALUES('{$catname}')";
	...
	<div class="overlay1 hide">
		<div class="box1 animate__animated animate__bounceIn">
			...
			<form method="get">
				<label class="top">Category Name</label>
				<input  required class="input1 top" type="text" name="catname">
