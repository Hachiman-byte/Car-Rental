...
<body>
	<div class="uppermost">
		...
		?>
			<img style="height:50px;width: 32px;" src="img/locate.png">
			<b><?php echo $rows['address']; ?></b>
			<img src="img/email.png">
			<b><?php echo $rows['email']; ?></b>
			<img src="img/phone.png">
			<b><?php echo $rows['contact_no']; ?></b>
		<?php
			}
		?>
	</div>
	<div class="background">
		...
		<form method="post" class="form_container animate__animated animate__bounceIn">
  <div class="logo_container"><img src="img/logo.png"></div>
  <div class="title_container">
    <p class="title">Login to your Account</p>
    <span class="subtitle">Get full access by logging in.</span>
  </div>
  <br>
  <?php  
		if (isset($_POST['login'])) {
			...
			if ($result->num_rows>0) {
				...
				echo "<p style='color:red;'>Incorrect Email and Password. Please try again.</p>";
			}
		}
	?>
  ...
  <button name="login"title="Sign In" type="submit" class="sign-in_btn">
    <span>Login</span>
  </button>
  ...
  <div class="separator">
    ...
    <a href="signup.php" class="sign-in_ggl">Sign Up</a>
