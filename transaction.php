...
<body>
	<h1 class="path">Admin | Transaction History</h1>
	<p class="path1">Admin > <i style="color: blue;">Transaction History</i> </p>
	<div class="top-left">
	...
	<div class="tablebox">
		<table>
				...
				<?php  
					$sql_show = "SELECT *
					from transaction
					INNER JOIN bookings ON transaction.booking_id = bookings.booking_id
