...
<body>
  <div class="body">
    <form method="post" class="form_container1 animate__animated animate__bounceIn">
  ...
  if (isset($_POST['login1'])) {
    ...
    $sql1 = "SELECT * FROM admin where username = '{$username}' AND password = '{$pass1}'";
    ...
    if ($result1->num_rows>0) {
      while ($data = $result1->fetch_assoc()) {
       ...
       echo "<p class='wrongpass'>Incorrect Username and Password. Plese try again.</p>";
      }
    }
  ?>
  <div class="input_container">
    ...
    <input placeholder="Username" title="Inpit title" name="username1" type="text" class="input_field" id="email_field">
  </div>
  <div class="input_container">
    ...
    <input placeholder="Password" title="Inpit title" name="pass1" type="password" class="input_field" id="password_field">
  </div>
  <button name="login1"title="Sign In" type="submit" class="sign-in_btn">
    <span>Login</span>
  </button>
</form>
  </div>
